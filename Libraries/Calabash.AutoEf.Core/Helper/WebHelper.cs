...
namespace Calabash.AutoEf.Core.Helper
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["Calabash.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["Calabash.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["Calabash.IsPOSTBeingDone"] = value;
            }
        }
